...
<div class="d-flex">
    ...
    <div class="sidebar flex-shrink-0 p-3 bg-dark text-white">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item"><a href="playlists.php" class="nav-link <?php echo in_array($currentPage, ['playlists', 'edit_playlist']) ? 'active' : ''; ?>"><i class="fas fa-list-ol me-2"></i>Playlists</a></li>
            ...
            <li class="nav-item"><a href="complaints.php" class="nav-link <?php echo in_array($currentPage, ['complaints', 'view_complaint']) ? 'active' : ''; ?>"><i class="fas fa-exclamation-triangle me-2"></i>Complaints</a></li>
        </ul>
        <hr>
        <div class="dropdown">
